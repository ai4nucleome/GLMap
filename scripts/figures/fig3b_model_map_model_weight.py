#!/usr/bin/env python3
"""Standalone Fig3b GLMap model map colored by model weight.
...
model map with a continuous color overlay for model parameter count.
...
def main() -> None:
    ...
    with plt.rc_context(local_rc):
        ...
        ax.set_title("GLMap model map colored by model weight", loc="center", pad=8)
